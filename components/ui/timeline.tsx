    ...
    >
      <div className="max-w-7xl mx-auto py-7 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Your Trip Itineray from <strong className="text-primary">{tripData?.origin}</strong> to <strong className="text-primary">{tripData?.destination} </strong>is Ready
        </h2>
       <div className="flex gap-5 items-center">
<div className="flex gap-2 items-center">
  <Calendar />
  <h2>{tripData?.duration}</h2> {/* ✅ fixed */}
</div>
